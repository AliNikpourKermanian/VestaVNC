 ...
 * Copyright (C) 2019 The vestavnc authors
...
export default class Display {
    ...
    _resumeRenderQ() {
        ...
        // display object
        this.removeEventListener('load', this._vestavncDisplay._resumeRenderQ);
        this._vestavncDisplay._scanRenderQ();
    }
