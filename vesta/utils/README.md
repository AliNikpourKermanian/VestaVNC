...
Websockify has been forked out into its own project. `vestavnc_proxy` will
...
the [websockify README](https://github.com/vestavnc/websockify/blob/master/README.md).

The other versions of websockify (C, Node.js) and the associated test
programs have been moved to
[websockify](https://github.com/vestavnc/websockify).  Websockify was
