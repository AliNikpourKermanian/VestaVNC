...
import { Monitor, Clipboard, Folder, Settings, Power, Maximize, Keyboard, Info } from "lucide-react"
...
export function Dock({ onClipboard, onFiles, onSettings, onDisconnect, onFullscreen }: DockProps) {
    return (
